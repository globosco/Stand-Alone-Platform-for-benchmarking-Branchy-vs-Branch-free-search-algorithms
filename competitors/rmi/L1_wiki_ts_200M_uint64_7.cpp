...
#include "L1_wiki_ts_200M_uint64_7_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L1_wiki_ts_200M_uint64_7 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L1_wiki_ts_200M_uint64_7_L1_PARAMETERS", std::ios::in | std::ios::binary);
