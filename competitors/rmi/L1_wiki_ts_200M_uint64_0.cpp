...
#include "L1_wiki_ts_200M_uint64_0_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L1_wiki_ts_200M_uint64_0_L1_PARAMETERS", std::ios::in | std::ios::binary);
