...
#include "L4_osm_cellids_200M_uint64_4_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_osm_cellids_200M_uint64_4_L1_PARAMETERS", std::ios::in | std::ios::binary);
