...
#include "L4_books_200M_uint64_9_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L4_books_200M_uint64_9 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_books_200M_uint64_9_L1_PARAMETERS", std::ios::in | std::ios::binary);
