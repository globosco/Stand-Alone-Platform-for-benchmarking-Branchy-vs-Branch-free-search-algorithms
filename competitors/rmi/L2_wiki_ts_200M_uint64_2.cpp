...
#include "L2_wiki_ts_200M_uint64_2_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L2_wiki_ts_200M_uint64_2_L1_PARAMETERS", std::ios::in | std::ios::binary);
