...
#include "L4_fb_200M_uint64_5_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L4_fb_200M_uint64_5 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_fb_200M_uint64_5_L1_PARAMETERS", std::ios::in | std::ios::binary);
