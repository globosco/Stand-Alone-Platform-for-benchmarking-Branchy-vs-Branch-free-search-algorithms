...
#include "L2_books_200M_uint32_3_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L2_books_200M_uint32_3 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L2_books_200M_uint32_3_L0_PARAMETERS", std::ios::in | std::ios::binary);
  ...
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L2_books_200M_uint32_3_L1_PARAMETERS", std::ios::in | std::ios::binary);
    if (!infile.good()) return false;
