...
#include "L4_osm_cellids_200M_uint64_0_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L4_osm_cellids_200M_uint64_0 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_osm_cellids_200M_uint64_0_L1_PARAMETERS", std::ios::in | std::ios::binary);
