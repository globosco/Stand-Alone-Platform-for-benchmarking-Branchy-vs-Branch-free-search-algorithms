...
#include "L3_wiki_ts_200M_uint64_3_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L3_wiki_ts_200M_uint64_3 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L3_wiki_ts_200M_uint64_3_L1_PARAMETERS", std::ios::in | std::ios::binary);
