...
#include "L4_fb_200M_no_outlayers_uint64_4_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L4_fb_200M_no_outlayers_uint64_4 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_fb_200M_no_outlayers_uint64_4_L1_PARAMETERS", std::ios::in | std::ios::binary);
