...
#include "L3_fb_200M_uint64_3_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L3_fb_200M_uint64_3_L0_PARAMETERS", std::ios::in | std::ios::binary);
  ...
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L3_fb_200M_uint64_3_L1_PARAMETERS", std::ios::in | std::ios::binary);
    if (!infile.good()) return false;
