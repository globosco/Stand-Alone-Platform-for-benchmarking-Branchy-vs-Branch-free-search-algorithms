...
#include "L4_osm_cellids_200M_uint64_5_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
...
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_osm_cellids_200M_uint64_5_L0_PARAMETERS", std::ios::in | std::ios::binary);
  ...
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_osm_cellids_200M_uint64_5_L1_PARAMETERS", std::ios::in | std::ios::binary);
    if (!infile.good()) return false;
