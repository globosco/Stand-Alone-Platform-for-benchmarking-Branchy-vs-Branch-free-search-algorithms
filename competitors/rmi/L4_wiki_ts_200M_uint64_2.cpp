...
#include "L4_wiki_ts_200M_uint64_2_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L4_wiki_ts_200M_uint64_2 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L4_wiki_ts_200M_uint64_2_L1_PARAMETERS", std::ios::in | std::ios::binary);
