...
#include "L3_wiki_ts_200M_uint64_8_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L3_wiki_ts_200M_uint64_8 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L3_wiki_ts_200M_uint64_8_L1_PARAMETERS", std::ios::in | std::ios::binary);
