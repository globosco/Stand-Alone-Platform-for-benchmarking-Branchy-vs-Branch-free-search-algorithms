...
#include "L2_osm_cellids_200M_uint64_6_data.h"
#include <math.h>
#include <cmath>
#include <fstream>
#include <filesystem>
#include <iostream>
namespace L2_osm_cellids_200M_uint64_6 {
bool load(char const* dataPath) {
  {
    std::ifstream infile(std::filesystem::path(dataPath) / "L2_osm_cellids_200M_uint64_6_L1_PARAMETERS", std::ios::in | std::ios::binary);
