  ...
  */
  ...
  int64_t ns;
    ...
    if(!strcmp(method, "bbs")){
        ...
        }else  if(dataset == "L1_books_200M"){
            const char * path = "rmi_data";
            L1_books_200M_uint64_5::load(path);
        }else if(dataset == "L2_books_200M"){
            const char * path = "rmi_data";
            L2_books_200M_uint64_6::load(path);
        }else if(dataset == "L3_books_200M"){
            const char * path = "rmi_data";
            L3_books_200M_uint64_6::load(path);
        }else if(dataset == "L4_books_200M"){
            const char * path = "rmi_data";
            L4_books_200M_uint64_5::load(path);
        }else  if(dataset == "L1_fb_200M"){
            const char * path = "rmi_data";
            L1_fb_200M_uint64_7::load(path);
        }else if(dataset == "L2_fb_200M"){
            const char * path = "rmi_data";
            L2_fb_200M_uint64_7::load(path);
        }else if(dataset == "L3_fb_200M"){
            const char * path = "rmi_data";
            L3_fb_200M_uint64_7::load(path);
        }else if(dataset == "L4_fb_200M"){
            const char * path = "rmi_data";
            L4_fb_200M_uint64_0::load(path);
        }else  if(dataset == "L1_wiki_ts_200M"){
            const char * path = "rmi_data";
            L1_wiki_ts_200M_uint64_6::load(path);
        }else if(dataset == "L2_wiki_ts_200M"){
            const char * path = "rmi_data";
            L2_wiki_ts_200M_uint64_6::load(path);
        }else if(dataset == "L3_wiki_ts_200M"){
            const char * path = "rmi_data";
            L3_wiki_ts_200M_uint64_5::load(path);
        }else if(dataset == "L4_wiki_ts_200M"){
            const char * path = "rmi_data";
            L4_wiki_ts_200M_uint64_0::load(path);
        }
            ...
            for (uint64_t pos = 0; pos < Q.size(); pos++){
                if(Q[pos] > A[A.size()-1]){
                    ...
                    if(dataset == "L1_osm_cellids_200M"){
                        ...
                        size_t err;
                        uint64_t guess = L1_books_200M_uint64_5::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L2_books_200M_uint64_6::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L3_books_200M_uint64_6::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L4_books_200M_uint64_5::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L1_fb_200M_uint64_7::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L2_fb_200M_uint64_7::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L3_fb_200M_uint64_7::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L4_fb_200M_uint64_0::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L1_wiki_ts_200M_uint64_6::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L2_wiki_ts_200M_uint64_6::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L3_wiki_ts_200M_uint64_5::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
                        ...
                        size_t err;
                        uint64_t guess = L4_wiki_ts_200M_uint64_0::lookup(Q[pos], &err);
                        uint64_t start = (guess < err ? 0 : guess - err);
                        uint64_t stop = (guess + err >= A.size() ? A.size() : guess + err);
